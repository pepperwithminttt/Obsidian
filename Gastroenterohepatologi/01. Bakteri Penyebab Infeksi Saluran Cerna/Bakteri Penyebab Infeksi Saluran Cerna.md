...
Gen kedua toksin berada pada **plasmid**.

- **LT** memiliki struktur dan fungsi yang mirip dengan **cholera toxin**.
- **ST** menyebabkan sekresi cairan intestinal dengan menstimulasi **guanylate cyclase**.

Akibat akhirnya adalah peningkatan cairan di lumen usus → **watery diarrhea**.

### Klinis

- Penyebab umum **traveler's diarrhea**    
- Dapat menginfeksi semua kelompok usia.
...
- Menempel pada sel usus halus melalui **fimbriae** yang dikode oleh plasmid dengan berat molekul besar.
- Bakteri membentuk kumpulan/aggregates kecil pada permukaan sel.
- Plasmid tersebut juga mengkode:
    - heat-stable enterotoxin
    - cytotoxin

Keduanya berhubungan dengan terjadinya diare.
...
🧠 **EAEC = Aggregates**  
Bayangkan bakterinya **bergerombol** di permukaan epitel. 👥🦠

---

## 3. Enteroinvasive Escherichia coli — EIEC

Mekanisme patogenesis EIEC belum sepenuhnya diketahui, tetapi mekanisme diare dianggap hampir sama dengan **Shigella spp.**
...
Beberapa pemeriksaan yang tercantum:
