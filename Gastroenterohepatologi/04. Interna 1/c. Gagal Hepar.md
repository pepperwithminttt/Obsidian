...
**Acute Liver Failure (ALF) / gagal hati akut** adalah sindrom akibat **cedera hati akut yang berat pada hati yang sebelumnya tidak memiliki penyakit hati kronis bermakna** sehingga fungsi hati menurun secara cepat dan menyebabkan:

- **Koagulopati:** **INR ≥1,5**, menunjukkan gangguan sintesis faktor koagulasi oleh hati.
- **Ensefalopati hepatik (EH):** gangguan fungsi otak akibat gagal hati, terutama berkaitan dengan akumulasi amonia dan gangguan metabolisme neurotoksin.
- Durasi penyakit umumnya **<26 minggu**.
- Tidak terdapat **sirosis sebelumnya**.

> **Intinya:**  
> **ALF = hati sebelumnya relatif normal → cedera akut berat → gagal fungsi hati + ensefalopati.**

ALF merupakan **kegawatdaruratan medis** karena kondisi dapat berkembang cepat menjadi **edema serebri, kegagalan multiorgan, dan kematian**.
...
**Cedera hati akut berat**  
↓  
**Nekrosis hepatosit masif**  
↓  
**Massa hepatosit fungsional menurun drastis**  
↓  
**Fungsi sintesis dan detoksifikasi hati gagal**  
↓  
**Hiperamonemia + hipoglikemia + peningkatan laktat + koagulopati**  
↓  
**Ensefalopati hepatik + edema serebri + gangguan sirkulasi**  
↓  
...
Cedera akut → amonia naik → otak mengalami ensefalopati/edema serebri.

---

## Manifestasi klinis ALF
...
## Diagnosis dan pemeriksaan awal ALF 🔎

Pendekatan diagnosis dapat diingat sebagai:
...
**Acute-on-Chronic Liver Failure (ACLF) / gagal hati akut pada penyakit hati kronis** adalah **perburukan akut penyakit hati kronis** yang disertai **kegagalan organ**, biasanya akibat respons inflamasi sistemik yang berat dan memiliki **mortalitas jangka pendek tinggi**.

Berbeda dengan ALF, pasien ACLF **sudah memiliki penyakit hati kronis**, sering berupa sirosis.

Namun, definisi ACLF **tidak sepenuhnya sama** antara **EASL, AASLD, dan APASL**. Secara umum, konsepnya adalah:

> **Penyakit hati kronis → pencetus akut → inflamasi sistemik berat → kegagalan organ → risiko kematian tinggi.**
...
Pada dasarnya, ACLF bukan sekadar “sirosis yang tiba-tiba memburuk”, tetapi melibatkan **inflamasi sistemik dan disfungsi organ**.

**Penyakit hati kronis/sirosis**  
↓  
**Cadangan fungsi hati rendah + hipertensi portal + disfungsi imun**  
↓  
**Pencetus akut** seperti infeksi, perdarahan, alkohol, atau HBV  
↓  
Pelepasan **PAMP dan DAMP**  
↓  
**Inflamasi sistemik + disregulasi imun**  
↓  
**Disfungsi mikrosirkulasi + gangguan metabolik/mitokondria**  
↓  
**Gangguan produksi energi sel**  
↓  
**Kegagalan organ**

**PAMP** (_pathogen-associated molecular patterns_) = molekul dari mikroorganisme yang dikenali sistem imun, misalnya komponen bakteri.

**DAMP** (_damage-associated molecular patterns_) = molekul yang dilepaskan sel/jaringan yang mengalami kerusakan.

Keduanya mengaktivasi sistem imun dan memicu pelepasan mediator inflamasi.
...
## Penilaian kegagalan organ: CLIF-OF 🏥

Pada ACLF, enam sistem organ utama dinilai:

|Sistem|Parameter utama|
|---|---|
|**Hati**|Bilirubin|
|**Ginjal**|Kreatinin / kebutuhan RRT|
|**Otak**|Derajat ensefalopati|
|**Koagulasi**|INR|
|**Sirkulasi**|MAP / kebutuhan vasopresor|
|**Respirasi**|PaO₂/FiO₂ atau SpO₂/FiO₂|

**RRT (renal replacement therapy)** = terapi pengganti fungsi ginjal, misalnya hemodialisis atau CRRT.

**MAP (mean arterial pressure)** = tekanan arteri rata-rata yang menggambarkan perfusi organ.

Jumlah dan berat kegagalan organ merupakan faktor penting dalam menentukan **prognosis jangka pendek**.
...
⚠️ Derajat ACLF **dapat berubah dengan cepat**, sehingga perlu dilakukan **evaluasi ulang secara berkala, terutama setiap hari atau ketika kondisi memburuk**.
...
## Tata laksana awal ACLF 🚑

Prinsip utama:

**Cari pencetus → obati pencetus → dukung organ → nilai perkembangan kegagalan organ → evaluasi transplantasi.**
...
# 3. TERAPI BERDASARKAN ETIOLOGI/PENCETUS 💊

|Kondisi|Tindakan awal|
|---|---|
|**Parasetamol**|N-asetilsistein segera|
|**HBV akut berat/reaktivasi**|Analog nukleos(t)ida poten + konsultasi hepatologi|
|**HSV**|Asiklovir IV bila dicurigai, sambil menunggu konfirmasi|
|**Infeksi/sepsis**|Antibiotik dini sesuai sumber dan resistensi lokal|
|**Perdarahan varises**|Vasoaktif + antibiotik + endoskopi segera|
|**HRS-AKI**|Albumin + vasokonstriktor sesuai protokol|
|**DILI**|Hentikan obat/herbal tersangka|
|**Wilson-ALF**|Rujuk transplantasi emergensi; terapi medis tidak boleh menunda transplantasi|

**HRS-AKI (hepatorenal syndrome–acute kidney injury)** adalah gangguan ginjal pada penyakit hati lanjut akibat perubahan sirkulasi sistemik dan renal yang berat, tanpa penyebab struktural ginjal sebagai mekanisme utama.

---

# 4. PERBEDAAN ALF vs ACLF 🧠

|Aspek|**ALF**|**ACLF**|
|---|---|---|
|**Latar hati**|Tidak ada penyakit hati kronis sebelumnya|Ada penyakit hati kronis/sirosis|
|**Awitan**|Akut, hari–minggu|Akut pada penyakit kronis|
|**Mekanisme utama**|Cedera hepatosit masif → kehilangan massa hati fungsional|Pencetus akut → inflamasi sistemik → kegagalan organ|
|**Ciri utama**|INR ≥1,5 + ensefalopati|Gagal hati + kegagalan organ|
|**Hipertensi portal**|Biasanya tidak ada pada awal|Sering ada|
|**Asites/varises**|Biasanya tidak ada|Sering ada|
|**Edema serebri**|Komplikasi penting|Relatif lebih jarang|
|**AKI**|Dapat terjadi|Sangat sering dan penting secara prognostik|
|**Kegagalan multiorgan**|Dapat terjadi pada kondisi berat|Merupakan karakteristik utama|
|**Prioritas**|Proteksi otak + terapi penyebab + evaluasi transplantasi|Kendalikan pencetus + dukungan multiorgan + evaluasi transplantasi|

### Cara paling gampang membedakan 🧠

**ALF:**  
🫀 **Hati awalnya tidak kronis**  
→ cedera akut  
→ **gagal fungsi hati**  
→ **ensefalopati**

**ACLF:**  
🫀 **Sudah ada penyakit hati kronis**  
→ pencetus akut  
→ **inflamasi sistemik**  
→ **banyak organ gagal**
...
# 6. PROGNOSIS, ICU, DAN TRANSPLANTASI 🚨
...
**ACLF yang dipicu oleh infeksi E. coli.**

### Mengapa?

Pasien sudah memiliki **sirosis HBV** → terdapat penyakit hati kronis.  
Kemudian terjadi **infeksi akut** → inflamasi sistemik → terjadi kegagalan beberapa organ.
...
**A**cute injury  
**L**iver function suddenly lost  
**F**ailure → **INR ↑ + encephalopathy**

### **ACLF = “4A”**

**A**da penyakit hati kronis  
**A**cute precipitant  
**A**ktivasi inflamasi sistemik  
**A**nak organ banyak yang gagal 😭

### Paling penting untuk ujian:

> **ALF → masalah utamanya adalah kehilangan massa hepatosit secara cepat + edema serebri.**  
> **ACLF → masalah utamanya adalah pencetus akut pada hati kronis + inflamasi sistemik + kegagalan multiorgan.**
