...
- Steatosis hepatik = terdapat **≥5% lemak di hati**, yang dapat dibuktikan dengan **pencitraan atau histologi**.
- Pemeriksaan biokimia saja **tidak dapat mendiagnosis steatosis**.
- Setelah menemukan steatosis, selalu tentukan:
    1. **Apa penyebabnya?**
    2. **Apakah terdapat faktor risiko metabolik dan/atau alkohol?**
    3. **Seberapa besar risiko fibrosis?**
...
|Kategori|Ciri utama|
|---|---|
|**MASLD**|Steatosis + ≥1 faktor risiko kardiometabolik, dengan konsumsi alkohol tidak mencapai rentang MetALD|
|**MetALD**|Steatosis + ≥1 faktor metabolik + konsumsi alkohol di atas rentang MASLD tetapi belum dominan alkohol|
|**ALD**|Steatosis terutama didorong oleh konsumsi alkohol|
...
**Steatosis hepatik + ≥1 faktor risiko kardiometabolik**
...
|---|--:|--:|
|**MASLD**|≤140 g/minggu|≤210 g/minggu|
|**MetALD**|>140–350 g/minggu|>210–420 g/minggu|
...
**Steatosis → steatohepatitis/MASH → fibrosis → sirosis → komplikasi**

⚠️ **ALT normal tidak menyingkirkan MASH maupun fibrosis lanjut.**
...
|---|---|
|**Metabolik**|Obesitas viseral, DM tipe 2, dislipidemia|
|**Alkohol**|Jumlah, durasi, dan pola konsumsi/binge drinking|
|**Obat**|Amiodaron, tamoksifen, metotreksat, kortikosteroid|
|**Genetik/metabolik**|Wilson disease, hypobetalipoproteinemia, lysosomal acid lipase deficiency|
|**Nutrisi**|Malnutrisi, penurunan berat badan cepat, nutrisi parenteral|
|**Endokrin**|Hipotiroidisme, Cushing syndrome, lipodistrofi|
|**Penyakit hati lain**|HBV, HCV, penyakit autoimun atau kolestatik|
|**Lainnya**|Beberapa infeksi dan kondisi metabolik tertentu|

🔎 **Petunjuk penyebab spesifik:** usia muda, riwayat keluarga, fenotipe tidak khas, pola laboratorium yang tidak sesuai, atau hubungan temporal dengan obat.

---

# 3. Patogenesis SLD dan MASH 🧬

Patogenesis MASH bersifat **multifaktorial dan terjadi melalui beberapa “parallel hits”**, bukan satu mekanisme tunggal.

### Alur utama

**Kelebihan energi + obesitas + predisposisi genetik**  
↓  
**Disfungsi jaringan adiposa + resistensi insulin**  
↓  
**Peningkatan aliran asam lemak bebas ke hati + peningkatan lipogenesis de novo**  
↓  
**Akumulasi trigliserida hepatosit → steatosis**  
↓  
**Lipotoksisitas**  
↓  
**Stres oksidatif + stres retikulum endoplasma + disfungsi mitokondria**  
↓  
**Cedera dan kematian hepatosit**  
↓  
**Aktivasi imunitas bawaan + inflamasi**  
↓  
**Aktivasi hepatic stellate cell**  
↓  
**Deposisi kolagen dan extracellular matrix**  
↓  
**Fibrosis → sirosis**
...
Akumulasi lemak sendiri belum tentu langsung menyebabkan cedera. Yang penting adalah peningkatan **spesies lipid toksik**.
...
Faktor metabolik dan pola makan dapat menyebabkan:

**Disbiosis + gangguan intestinal barrier**  
↓  
**Peningkatan permeabilitas usus**  
↓  
**Produk mikroba masuk ke vena porta**  
↓  
**Aktivasi Kupffer cell dan respons inflamasi**  
↓  
**Aktivasi hepatic stellate cell**  
↓  
**Deposisi kolagen → fibrosis**

Sinyal dari **asam empedu dan metabolit mikroba** juga ikut menghubungkan metabolisme usus dan hati.
...
# 4. Perjalanan Penyakit dan Manifestasi Klinis
...
**Sirosis F4**  
↓  
**Hipertensi portal/dekompensasi**  
↓  
**HCC**

Tidak semua pasien akan mengalami progresi sampai tahap akhir.
...
> **Konfirmasi steatosis → tentukan penyebab → nilai cedera/fungsi hati → nilai fibrosis**
...
### B. Pemeriksaan laboratorium awal
...
# 6. Penilaian Fibrosis 🧮

Ini bagian yang sangat penting karena **fibrosis menentukan prognosis hati**.

### Langkah pertama: FIB-4
...
|FIB-4|Interpretasi/tindakan|
|---|---|
|**<1,3**|Risiko fibrosis lanjut rendah → tata laksana metabolik + evaluasi berkala|
|**1,3–2,67**|Risiko tidak pasti → lanjutkan VCTE atau ELF|
|**>2,67**|Risiko tinggi → evaluasi spesialis/hepatologi|
|**Usia >65 tahun**|Gunakan sekitar **2,0** sebagai batas bawah untuk pemeriksaan lanjutan|
...
# 7. Diagnosis Banding dan Kondisi yang Dapat Menyertai

Pasien dapat memenuhi kriteria MASLD **dan tetap memiliki penyakit hati lain**.
...
> **Lifestyle + kontrol faktor metabolik + pengurangan risiko hati + pemantauan fibrosis**
...
# 9. Terapi Farmakologis MASH 💊

Terapi yang secara spesifik menargetkan MASH **bukan terapi rutin untuk semua pasien fatty liver**.

Pada pasien tertentu dengan **MASH non-sirosis dan fibrosis F2–F3**, terapi dapat dipertimbangkan oleh dokter spesialis sesuai kriteria dan regulasi setempat.
...
📌 **Penting:** persetujuan BPOM, ketersediaan, indikasi, dan label produk lokal harus diverifikasi sebelum terapi diberikan.

---

# 10. Komplikasi dan Penyakit Lanjut 🚨
...
# 🧠 ALGORITME BESAR YANG WAJIB DIHAFAL

Kalau ketemu pasien dengan **steatosis/fatty liver**, pikirkan:

**1. CONFIRM**  
Apakah benar ada steatosis?  
→ USG / CAP / MRI-PDFF

**2. CLASSIFY**  
Apa penyebabnya?  
→ Metabolik? Alkohol? Obat? Viral? Genetik? Nutrisi/endokrin?

**3. IDENTIFY MASLD**  
Steatosis + ≥1 faktor kardiometabolik  
→ MASLD
...
→ **FIB-4**  
→ jika ≥1,3: **VCTE/ELF**  
→ bila discordant/kompleks: **MRE ± biopsi**

**6. MANAGE**  
→ penurunan berat badan  
→ pola makan sehat  
→ olahraga  
→ kontrol DM, hipertensi, dislipidemia, obesitas  
→ kurangi/hindari alkohol

**7. REFER** 🚨  
→ fibrosis tinggi, red flags, etiologi tidak jelas, atau penyakit lanjut
